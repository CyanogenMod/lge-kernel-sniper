...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2011.10.24] - Justin Featuring
//#if ( defined(CONFIG_DOMESTIC) && defined(CONFIG_MACH_LGE_JUSTIN) )
#if ( defined(CONFIG_PRODUCT_LGE_LU6800) )
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2011.10.24]- Justin Featuring
int axis_map_x = 1; 
int axis_map_y = 0; 
int axis_map_z = 2; 
