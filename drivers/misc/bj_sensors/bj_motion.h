...
#define MOTION_IOCTL_READ_MAGNETIC_TYPE 		_IOWR(MOTION_MAGIC, 0x16, short)

#define MOTION_IOCTL_CHECK_SENSOR_I2C_ERROR	    		_IOWR(MOTION_MAGIC, 0x17, short)
#define MOTION_IOCTL_REBOOT_SENSORS 		_IOWR(MOTION_MAGIC, 0x18, short)
#define MOTION_IOCTL_COMPASS_INIT 		_IOWR(MOTION_MAGIC, 0x19, short)
