 ...
 * \verbatim
   ...
   $History: tmbslTDA9984_functions.h $
 *
 *
 * **************** Version 11  ******************
 ...
 *
 ******************  Version 10  ****************
 * User: G. Burnouf     Date: 25/03/08
 * Updated in $/Source/tmbslTDA9984/Inc
 * PR1244 : return connection tree depth value
 *
 * **************** Version 9  ******************
 * User: G.Burnouf     Date: 05/02/08
 * Updated in $/Source/tmbslTDA9984/Inc
 * PR1251 : add new function 
 ...
 *
 * *****************  Version 5  ****************
 * User: G.Burnouf     Date: 09/11/07   Time: 11:19
 * Updated in $/Source/tmbslTDA9984/Inc
 * PR941 : Remove function for app.c file configuration
 *
 *******************  Version 4  *****************
 * User: B.Vereecke   Date: 01/10/07   Time: 13:32
 * Updated in $/Source/tmbslTDA9984/Inc
 * PR766   - Rename pseudo API functions
 *
 * *****************  Version 3  *****************
 * User: G.Burnouf   Date: 10/09/07   Time: 17:22
 * Updated in $/Source/tmbslTDA9984/Inc
 * PR656 : - add HBR format
 *         - add format I2s Philips left and right justified 
 *
 * *****************  Version 2  *****************
 * User: G. Burnouf      Date: 09/08/07   Time: 10:30
 * Updated in $/Source/tmbslTDA9984/Inc
 * PR572 - remove type and enum from file 
 *         tmbslTDA9984_functions.h
 *
 * *****************  Version 1  *****************
...
#ifndef TMBSLTDA9984_FUNCTIONS_H
#define TMBSLTDA9984_FUNCTIONS_H
...
/**
    ...
    \note       The consumer use bit (bit0) and Mode bits (bits6-7) are forced to zero.
                Use tmbslTDA9984AudioOutSetChanStatusMapping to set CS Byte 2.
...
/**
    ...
    \note       Use tmbslTDA9984AudioOutSetChanStatus to set all other CS bytes
...
/**
    ...
    \note       tmbslTDA9984PktSetGeneralCntrl must be used to control the audio
...
/**
    ...
    \sa         tmbslTDA9984EdidGetBlockData
 */
tmErrorCode_t
...
/**
    \brief      Set Sink Type by analysis of the EDID content force it

    \param[in]  txUnit      Transmitter unit number
    \param[out] sinkType    Sink Type: EDID dependant, or force DVI or HDMI
...
/**
    \brief      Check the result of an HDCP encryption attempt, called at
                intervals (set by uTimeSinceLastCallMs) after tmbslTDA9984HdcpRun
...
/**
    ...
    \note       The user BCAPS interrupt handler (registered with 
                tmbslTDA9984Init) calls this API before calling 
...
/**
    ...
    \note       The user BCAPS interrupt handler (registered with 
                tmbslTDA9984Init) calls this API after calling 
                tmbslTDA9984HdcpHandleBCAPS
*/
tmErrorCode_t
tmbslTDA9984HdcpHandleBKSV
...
/**
    ...
    \note       Must be called before tmbslTDA9984HdcpRun
*/
tmErrorCode_t
...
/**
    ...
    \note       Must be called after tmbslTDA9984HdcpInit
*/
tmErrorCode_t
tmbslTDA9984HdcpRun
(
...
/**
    \brief      Get the hot plug input status last read by tmbslTDA9984Init
                or tmbslTDA9984HwHandleInterrupt

    \param[in]  txUnit          Transmitter unit number
    \param[out] pHotPlugStatus  Pointer to returned Hot Plug Detect status
    \param[in]  client          Used to determine whether the request comes from the client application
...
/**
    \brief      Get the rx sense input status last read by tmbslTDA9984Init
                or tmbslTDA9984HwHandleInterrupt
...
/**
    ...
    \note       tmbslTDA9984AudioInSetCts sets CTS and N values
 */
tmErrorCode_t
...
/**
    ...
    \note       tmbslTDA9984AudioOutSetMute must be used to mute the audio output
 */
tmErrorCode_t
...
*/
tmErrorCode_t tmbslTDA9984HdcpGetSinkCategory
(
    tmUnitSelect_t              txUnit,
...
*/
tmErrorCode_t tmbslTDA9984EdidGetLatencyInfo
(
    tmUnitSelect_t             txUnit,
...
#endif /* TMBSLTDA9984_FUNCTIONS_H */
