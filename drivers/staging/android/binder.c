...
static DEFINE_MUTEX(binder_mmap_lock); // kyoungpyo.kang 121021 fq_rca 12_0835 patch
...
struct binder_proc {
	...
	struct mm_struct *vma_vm_mm; // kyoungpyo.kang 120913 patch
...
static void binder_vma_close(struct vm_area_struct *vma)
{
	...
	binder_debug(BINDER_DEBUG_OPEN_CLOSE,
		     ...
		     (unsigned long)pgprot_val(vma->vm_page_prot));
	proc->vma = NULL;
	proc->vma_vm_mm = NULL; // kyoungpyo.kang 120913 patch
...
static int binder_mmap(struct file *filp, struct vm_area_struct *vma)
{
	...
	mutex_lock(&binder_mmap_lock); // kyoungpyo.kang 121021 fq_rca 12_0835 patch
	if (proc->buffer) {
		ret = -EBUSY;
	...
	mutex_unlock(&binder_mmap_lock); // kyoungpyo.kang 121021 fq_rca 12_0835 patch
	...
	proc->vma = vma;
	proc->vma_vm_mm = vma->vm_mm; // kyoungpyo.kang 120913 patch
