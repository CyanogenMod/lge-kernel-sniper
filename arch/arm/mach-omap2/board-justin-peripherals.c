...
//--[[ LGE_UBIQUIX_MODIFIED_START : ymjun@mnbt.co.kr [2012.03.26] - CAM from GB
...
#endif
//--]] LGE_UBIQUIX_MODIFIED_END : ymjun@mnbt.co.kr [2012.03.26] - CAM from GB
...
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2012.03.13] - Add the LU6800-Keymap data
#if defined(CONFIG_PRODUCT_LGE_LU6800)
	KEY(0, 0, KEY_HOME),
	KEY(1, 0, KEY_VOLUMEUP),
	KEY(2, 0, KEY_VOLUMEDOWN),
	KEY(2, 1, KEY_TESTMODE_UNLOCK),
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2012.03.13]- Add the LU6800-Keymap data
#else
...
#if defined(CONFIG_TOUCHSCREEN_JUSTIN_KR_SYNAPTICS)
	{
		I2C_BOARD_INFO("hub_synaptics_touch", 0x20),
		.platform_data = &hub_ts_synaptics_platform_data,
		.irq = OMAP_GPIO_IRQ(HUB_TS_I2C_INT_GPIO),
	},
//--[[ LGE_UBIQUIX_MODIFIED_START : shyun@ubiquix.com [2012.03.13] - Keytouch feature is added.
	{
		I2C_BOARD_INFO("hub_keytouch",	(0x2C)),
	},		
//--]] LGE_UBIQUIX_MODIFIED_END : shyun@ubiquix.com [2012.03.13]- Keytouch feature is added.
#endif
// 20100619 jh.koo@lge.com Hub touchscreen [END_LGE]
