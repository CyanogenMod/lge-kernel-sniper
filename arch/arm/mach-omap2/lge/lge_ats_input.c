/*
 *  arch/arm/mach-omap2/lge/lge_ats_input.c
 *
...
static int  __init ats_input_probe(struct platform_device *pdev)
{
	...
	input_set_abs_params(ats_input_dev, ABS_MT_POSITION_X, 0, 480, 0, 0);
	input_set_abs_params(ats_input_dev, ABS_MT_POSITION_Y, 0, 800, 0, 0);
